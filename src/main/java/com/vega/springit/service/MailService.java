...
/**
 * DON'T TRY THAT, BECAUSE I DON'T HAVE A MAIL SERVICE PROVIDER
 */
@Service
public class MailService {
  ...
  // javaMailSender wird von Spring Boot initialisiert anhand der spring.mail Properties im property file
